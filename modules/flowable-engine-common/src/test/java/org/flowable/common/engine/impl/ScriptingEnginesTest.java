...
public class ScriptingEnginesTest {
    ...
    public void expectScriptTraceEnhancersAreAppliedForErrorTraceListenerAndCalledForErrorsOnlyByDefault() {
        ...
        engines.setScriptTraceListener(trace -> capturedTrace.add(trace));
    ...
    public void expectScriptTraceEnhancersAreAppliedForErrorTraceListenerAndCapturesAll() {
        ...
        engines.setScriptTraceListener(new ScriptTraceListener() {

            @Override
            public boolean shouldBeTraced(ScriptEngineRequest request, boolean error) {
                return true;
            }

            @Override
            public void onScriptTrace(ScriptTrace scriptTrace) {
                capturedTrace.add(scriptTrace);
            }
        });
